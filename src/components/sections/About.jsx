...
export default function About() {
    return (
        <section id="about" className="py-20 md:py-32 border-b border-black/10 bg-background">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16 md:gap-y-24">
                            {[
                                ...
                                <div key={idx} className="space-y-4 md:space-y-6">
                                    <h3 className="text-lg md:text-xl font-bold tracking-tight text-primary uppercase border-l-2 border-black pl-5">
                                        {item.title}
                                    </h3>
